...
type SlideId = "home" | "about" | "work" | "tools" | "experience";
...
export default function App() {
  ...
  const slides = useMemo(
    () => [
      { id: "home", component: <Hero theme={theme} language={language} onNavigateToWork={() => scrollToSection("work")} /> },
      { id: "about", component: <About theme={theme} language={language} /> },
      { id: "work", component: <CaseStudies theme={theme} language={language} /> },
      { id: "tools", component: <Tools theme={theme} language={language} /> },
      { id: "experience", component: <Experience theme={theme} language={language} /> },
    ],
